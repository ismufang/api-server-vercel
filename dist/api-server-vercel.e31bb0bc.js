...
var _default = {
  ...
  data: function data() {
    return {
      name: 'api-server',
      apiList: _index.default
    };
  }
};
exports.default = _default;
        var $be45cb = exports.default || module.exports;
      
      if (typeof $be45cb === 'function') {
        $be45cb = $be45cb.options;
      }
    
        /* template */
        Object.assign($be45cb, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", [
    ...
    _c(
      "ul",
      _vm._l(_vm.apiList, function(key, value) {
        return _c("li", { key: key }, [
          _c("a", { attrs: { href: key } }, [_vm._v(_vm._s(value))])
        ])
      }),
      0
    )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$be45cb', $be45cb);
          } else {
            api.reload('$be45cb', $be45cb);
          }
        }
...
},{"./api/index.js":"api/index.js","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=/api-server-vercel.e31bb0bc.js.map